(function () {
	...
	.constant('SearchPath', "https://davids-restaurant.herokuapp.com");
	...
	MenuSearchService.$inject = ['$http', 'SearchPath'];
	function MenuSearchService($http, SearchPath) {
  		var service = this;

 		service.getMatchedMenuItems = function (searchTerm) {
  			return $http({
 	 	    	method: "GET",
   		    	url: (SearchPath+"/menu_items.json")
